...
glm::mat4 C_DirectionalLight::GetProjectionMatrix() const
{
	...
	//C_DebugDraw::Instance().DrawAABB(camerasAABB, rotation, viewProjectionMatrix, glm::vec3(1.0f, 0.0f, 0.0f)); // aabb kamery ve light view space 
	//C_DebugDraw::Instance().DrawAABB(transformedAABB, glm::mat4(1.0f), viewProjectionMatrix, glm::vec3(0.0f, 0.0f, 1.0f));//aabb n world space
	//C_DebugDraw::Instance().DrawAABB(transformedAABB, glm::inverse(rotation), viewProjectionMatrix, glm::vec3(0.0f, 0.0f, 1.0f));//aabb n light space
